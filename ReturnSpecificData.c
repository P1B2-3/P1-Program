...
typedef int datint;
char * ReturnSpeceficData(char * indput, datint indput_nr_class,   datint indput_nr_subject, 
    ...
    if(!strcmp(indput,"examens_class_ID")) {
        ...
        && indput_nr_censor  == -1
        && indput_nr_student == -1) {
            strcpy(tempStr,datablock[indput_nr_datablock].subjects[indput_nr_subject].teacher.name);
            strcat(tempStr," ");
            strcat(tempStr,datablock[indput_nr_datablock].subjects[indput_nr_subject].teacher.surname);
            return tempStr;
        }else if(indput_nr_teacher == -1 
             && indput_nr_censor  != -1
             && indput_nr_student == -1){
            strcpy(tempStr,datablock[indput_nr_datablock].subjects[indput_nr_subject].censor.name);
            strcat(tempStr," ");
            strcat(tempStr,datablock[indput_nr_datablock].subjects[indput_nr_subject].censor.surname);
            return tempStr;
        }else if(indput_nr_teacher == -1 
             && indput_nr_censor  == -1
             && indput_nr_student != -1){
        ...
        itoa(datablock[indput_nr_datablock].year,buffer,10);

        strcpy(tempStr,buffer);
        strcat(tempStr,".");
        strcat(tempStr,datablock[indput_nr_datablock].name);
        return tempStr;
    }
        ...
        && indput_nr_censor  == -1
        && indput_nr_student == -1) 
            return datablock[indput_nr_datablock].subjects[indput_nr_subject].teacher.unikID;
        else if(indput_nr_teacher == -1 
             && indput_nr_censor  != -1
             && indput_nr_student == -1)
            return datablock[indput_nr_datablock].subjects[indput_nr_subject].censor.unikID;
        else if(indput_nr_teacher == -1 
             && indput_nr_censor  == -1
             && indput_nr_student != -1)
            return datablock[indput_nr_datablock].student[indput_nr_student].unikID;
        else
            printf("Error; indput nr incorrect.");
    }
    else if(!strcmp(indput,"subject_number")) {
        return datablock[input_nr_datablock].student[indput_nr_student].exam_numbrer;
    }
    else if(!strcmp(indput,"subject_name")) {
        return datablock[indput_nr_datablock].subject[indput_nr_subject].subject;
    }
    else if(!strcmp(indput,"lokale")) {
        return datablock[indput_nr_datablock].subject[indput_nr_subject].ClassExam[indput_nr_subject].room;
    }
